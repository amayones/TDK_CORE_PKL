...
import { fetchTesList, createTes, updateTes, deleteTes } from '../services/tesService';
import TesFormModal from '../components/TesFormModal';
...
export default function TesPage() {
    ...
    const handleSubmit = async (form) => {
        ...
        try {
            if (editingItem) {
                await updateTes(editingItem.id, form);
                window.__APP__.alert('Data berhasil diupdate', 'success');
            } else {
                await createTes(form);
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                <div>
                    <h2 className="text-lg font-semibold text-gray-800">Tes</h2>
                    <p className="text-gray-500 text-sm">Kelola data tes.</p>
                </div>
                {hasPermission('tes', 'can_create') && (
                    <button
