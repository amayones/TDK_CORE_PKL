        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
                    <div>
                        <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1.5">Group</label>
                        <select
                            name="group_id"
                            value={form.group_id}
                            onChange={handleChange}
                            className="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#30AFFF]"
                            required
                        >
                    ...
                    <div>
                        <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1.5">
                            Password {initialData && <span className="text-gray-400 normal-case font-normal">(kosongkan jika tidak diubah)</span>}
                        </label>
                        <input
                            type="password"
                            name="password"
                    ...
                    <div className="flex justify-end gap-2 pt-2">
                        ...
                        <button
                            type="submit"
                            disabled={submitting}
                            className="px-4 py-2 text-sm rounded-xl text-white font-medium disabled:opacity-50 hover:opacity-90 transition-opacity"
